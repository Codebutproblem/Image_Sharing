...
function SavePinBox({ setShowSaveBox, setSaved, pinId }) {
  ...
  return (
    <div
      onClick={hideSaveBox}
      className="fixed z-[150] top-0 left-0 right-0 bottom-0 bg-[#00000040]"
    >
      <div
        onClick={saveBoxClick}
        className="flex flex-col absolute bg-slate-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] min-w-[280px] sm:w-[460px]  rounded-xl my-3"
      >
        ...
        <div className="p-3">
          <button
            ...
            className="w-full p-2 bg-orange-500 hover:bg-orange-600 rounded-xl text-slate-50 text-xl"
          >
            Xác nhận
          </button>
        </div>
