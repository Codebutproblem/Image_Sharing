...
function DragDropImageUploader() {
  ...
  if (uploader.file) {
    return (
      <div className="relative z-10 w-[300px] lg:w-[430px] min-w-[300px] lg:min-w-[430px] rounded-2xl overflow-hidden box-border p-2">
        <img
          src={imagePath}
          alt="preview"
  ...
  return (
    <div className="relative w-[300px] lg:w-[430px] min-w-[300px] lg:min-w-[430px] h-[500px] border-2 border-slate-400 rounded-2xl overflow-hidden box-border p-2 bg-slate-200">
