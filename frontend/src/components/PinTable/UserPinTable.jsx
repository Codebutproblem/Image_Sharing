    ...
    <div className="pb-5">
      <ImageList variant="standard" cols={columns} gap={8}>
        {pinObject.pins.map((pin) => (
          <ImageListItem key={pin.id} className=" rounded-2xl overflow-hidden">
            ...
            >
              <div className="flex justify-between items-center">
                ...
                {userObject?.isMe && (
                  <Link
                    to={`/profile/edit-pin/${pin.slug}`}
                    onClick={(e) => e.stopPropagation()}
                    className=" bg-gray-500 duration-200 hover:bg-gray-600 p-2 rounded-full cursor-pointer"
                  >
